# Generated by Django 3.1.5 on 2021-02-07 19:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reg_confirmed_date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('loading_time', models.DateTimeField(auto_now_add=True)),
                ('picture_itself', models.ImageField(upload_to='photos/%Y/%m/%d/')),
                ('description', models.TextField(blank=True)),
                ('picture_preview', models.ImageField(upload_to='photos/%Y/%m/%d/')),
                ('avatar_of', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='avatar', to=settings.AUTH_USER_MODEL)),
                ...
                ('uploader', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uploaded_pictures', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Like',
